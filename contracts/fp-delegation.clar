...
(define-private (stack-aggregation-commit (reward-cycle uint))
  (match (map-get? pox-addr-indices reward-cycle)
            index (as-contract (contract-call? 'SP000000000000000000002Q6VF78.pox-2 stack-aggregation-increase (var-get pox-address) reward-cycle index))
            (match (as-contract (contract-call? 'SP000000000000000000002Q6VF78.pox-2 stack-aggregation-commit-indexed (var-get pox-address) reward-cycle))
              index (begin
